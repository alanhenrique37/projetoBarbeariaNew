    ...
    <div class="row gy-4 gy-lg-0">
      <div class="col-12 col-lg-4">
        <div class="card border-0">
          <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
            <a href="#!">
              <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="images/renato.jpg" alt="Flora Nyra">
            </a>
            <figcaption>
          ...
          <div class="card-body border bg-white p-4">
            ...
            <p class="card-text text-secondary">Renato é barbeiro experiente e dono da barbearia. Além de ser mestre nas técnicas de corte, ele cria um ambiente acolhedor e descontraído, sempre garantindo que cada cliente saia com o visual perfeito e único. Com sua paixão pelo ofício, ele transforma cada visita em uma experiência de estilo e confiança.</p>
          </div>
      ...
      <div class="col-12 col-lg-4">
        <div class="card border-0">
          <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
            <a href="#!">
              <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="images/br.jpg" alt="James Levi">
            </a>
            <figcaption>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-eye text-white bsb-hover-fadeInLeft" viewBox="0 0 16 16">
                <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
          ...
          <div class="card-body border bg-white p-4">
            ...
            <p class="card-text text-secondary">Bryan é um barbeiro habilidoso, com um toque diferenciado e sempre atento aos detalhes. Ele faz com que cada corte seja preciso e, ao mesmo tempo, transforma a barbearia num lugar descontraído e agradável.</p>
          </div>
          <div class="card-footer border border-top-0 bg-white p-4">
            <ul class="nav mb-0 bsb-nav-sep">
              <li class="nav-item text-secondary">
      ...
      <div class="col-12 col-lg-4">
        <div class="card border-0">
          <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
            <a href="#!">
              <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="images/jp.jpg" alt="Taytum Elia">
            </a>
            <figcaption>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-eye text-white bsb-hover-fadeInLeft" viewBox="0 0 16 16">
                <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
          ...
          <div class="card-body border bg-white p-4">
            ...
            <p class="card-text text-secondary">João Pedro é um barbeiro talentoso que entrega cortes impecáveis com muita personalidade. Sempre carismático e atento, ele garante que cada cliente saia de lá com o visual afiado e um sorriso no rosto.</p>
          </div>
          <div class="card-footer border border-top-0 bg-white p-4">
            <ul class="nav mb-0 bsb-nav-sep">
              <li class="nav-item text-secondary">
